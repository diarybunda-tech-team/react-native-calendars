...
export default class PeriodDay extends Component {
    ...
    render() {
        ...
        if (marking) {
            ...
            fillers = (<View style={[this.style.fillers, fillerStyle]}>
        ...
        <View style={this.style.wrapper}>
          ...
          <View style={containerStyle}>
              <View style={{borderWidth: 1, borderRadius: 999, borderColor: 'red', width: Spacing[28], height: Spacing[28], alignItems: 'center', position:'absolute', top: Spacing[2]}}/>
